...
%% toc spacing
\usepackage{tocloft}
\setlength\cftbeforetoctitleskip{14pt}    % change space before TOC title
\setlength\cftaftertoctitleskip{8pt}     % change space after  TOC title
\setlength\cftbeforesecskip{8pt}          % change space before sections
\renewcommand\cftsecafterpnum{\vskip0pt}  % change space after subsections
